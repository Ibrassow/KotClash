...
open class Entity(enemy: Boolean,
                  coordinates : Pair<Float,Float>,
                  gameManager: GameManager,
                  currentOrientation: Float
) : GameObject(enemy, coordinates, currentOrientation, gameManager) {    //open var view:GameObjectView,
    ...
    fun getClosestEnemy(listEnemiesInRange: ArrayList<Entity>): Entity?{
        target = null //ATTENTION ! Artifice pour pas utiliser nullable
